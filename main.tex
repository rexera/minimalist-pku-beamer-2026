% 画幅切换：aspectratio=43（4:3，默认）↔ aspectratio=169（16:9）
\documentclass[10pt,aspectratio=43,hyperref={colorlinks,citecolor=peking_blue,urlcolor=peking_blue,linkcolor=}]{beamer}
\usepackage{PekingU}
\usefonttheme{serif}
\usepackage{lipsum}
